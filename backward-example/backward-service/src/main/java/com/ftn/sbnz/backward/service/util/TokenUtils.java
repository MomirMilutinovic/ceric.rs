package com.ftn.sbnz.backward.service.util;
...
public class TokenUtils {
	...
	private Boolean isCreatedBeforeLastPasswordReset(Date created, Date lastPasswordReset) {
		long tokenCreationSeconds = created.getTime() / 1000 * 1000;
		long lastPasswordResetSeconds = lastPasswordReset.getTime() / 1000 * 1000;
		// Precision has to be reduced to seconds a login immediately after a forced password
		// change gets registered as having happened before the password was changed
		return (lastPasswordReset != null && (tokenCreationSeconds <  lastPasswordResetSeconds));
	}
